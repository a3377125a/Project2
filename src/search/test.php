...
<div id="search">
    ...
    <div class="second">
        <form action="search-action.php" method="post">
            <div class="by-title">
                <div><input type="radio"  name="title" value="1" checked><span>Filter by Title</span></div>
                <input type="text"  name="title-text">
            </div>
            <div class="by-description">
                <div><input type="radio" name="title" value="2"><span>Filter by Description</span></div>
