...
<div id="photo">
    ...
    <div class="pics">
        ...
        $userID = $row1[0][0];
        $sql2 = "SELECT ImageID FROM travelimage WHERE UID='$userID'";
        ...
        if ($total == 0) {
            ?>
            <div class="tip">
                <h1>您还没有上传照片，赶紧点击个人中心内的上传按钮增加一张吧!</h1>
            </div>
            <?php
        } else {
        $pic_per_page = 4;
        ...
        $sql3 = "SELECT ImageID FROM travelimage WHERE UID='$userID' LIMIT $start_from, $pic_per_page";
            ...
            <div class="blocks">
                ...
                <div class="right">
                    ...
                    <div class="buttons">
                        ...
                        echo "<a href=\"../upload/upload.php?imgID=".$imgID."\" class=\"modify\">"."Modify";
                        ?>
                    </div>
                </div>
            </div>
        ...
        <div class="foot">
            <?php
            echo "<a href='my-photos.php?page=" . ($page > 1 ? $page - 1 : 1) . "'>" . "<<" . "</a> ";
            for ($i = 1; $i <= $page_num; $i++) {
                echo "<a href='my-photos.php?page=" . $i . "'";
                if ($page == $i) {
                    echo "class='sp_page_num'";
                }
                echo ">" . $i . "</a> ";
            };
            echo "<a href='my-photos.php?page=" . ($page < $page_num ? $page + 1 : $page_num) . "'>" . ">>" . "</a> ";
            }
            ?>
        </div>
